...
import GameverseContent from '@/components/Windows/MyProjects/GameverseContent.vue'
import MasteruniContent from '@/components/Windows/MyProjects/MasteruniContent.vue'
import AzmiuContent from '@/components/Windows/MyProjects/AzmiuContent.vue'
import CpyContent from '@/components/Windows/MyProjects/CpyContent.vue'
import TechguardContent from '@/components/Windows/MyProjects/TechguardContent.vue'
import ContheronContent from '@/components/Windows/MyProjects/ContheronContent.vue'
...
const getLocalizedCategoryName = (category) => {
  return category.name[localeStore.currentLocale] || category.name['az']
}

// Computed property to get the localized title
const localizedTitle = computed(() => {
  return goBackStore.currentActiveProject?.title[localeStore.currentLocale] || goBackStore.currentActiveProject?.title['az']
})

// Computed property to get the localized date
const localizedDate = computed(() => {
  return goBackStore.currentActiveProject?.date[localeStore.currentLocale] || goBackStore.currentActiveProject?.date['az']
})
